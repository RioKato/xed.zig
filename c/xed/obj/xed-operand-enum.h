...
#define XED_OPERAND_DFV_DEFINED 1
...
#define XED_OPERAND_ENC_DELETE_DEFINED 1
...
#define XED_OPERAND_PREFETCHIT_DEFINED 1
#define XED_OPERAND_PREFETCHRST_DEFINED 1
...
typedef enum {
  ...
  XED_OPERAND_POS_SIB,
  XED_OPERAND_PREFETCHIT,
  XED_OPERAND_PREFETCHRST,
