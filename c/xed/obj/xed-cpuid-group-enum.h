...
#define XED_CPUID_GROUP_APX_F_AMX_TRANSPOSE_DEFINED 1
#define XED_CPUID_GROUP_APX_F_AMX_TRANSPOSE_MOVRS_DEFINED 1
...
typedef enum {
  ...
  XED_CPUID_GROUP_APX_F_AMX_TRANSPOSE,
  XED_CPUID_GROUP_APX_F_AMX_TRANSPOSE_MOVRS,
