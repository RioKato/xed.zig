...
{"DEFAULT_FLAGS", XED_ATTRIBUTE_DEFAULT_FLAGS},
...
Here is a skeleton switch statement embedded in a comment
  ...
  case XED_ATTRIBUTE_APX_NDD:
  case XED_ATTRIBUTE_APX_NF:
  case XED_ATTRIBUTE_ATOMIC:
  case XED_ATTRIBUTE_ATT_OPERAND_ORDER_EXCEPTION:
  case XED_ATTRIBUTE_BROADCAST_ENABLED:
  case XED_ATTRIBUTE_BYTEOP:
  case XED_ATTRIBUTE_DEFAULT_FLAGS:
  ...
  case XED_ATTRIBUTE_DISP8_NO_SCALE:
  ...
  case XED_ATTRIBUTE_FIXED_ROUNDING_RNE:
  case XED_ATTRIBUTE_FLUSH_INPUT_DENORM:
  case XED_ATTRIBUTE_FLUSH_OUTPUT_DENORM:
  ...
  case XED_ATTRIBUTE_NO_REG_MATCH:
  ...
  case XED_ATTRIBUTE_REQUIRES_ALIGNMENT_4B:
  case XED_ATTRIBUTE_REQUIRES_ALIGNMENT_8B:
  ...
  case XED_ATTRIBUTE_UNDOCUMENTED:
