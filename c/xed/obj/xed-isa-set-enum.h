...
#define XED_ISA_SET_APX_F_AMX_TRANSPOSE_DEFINED 1
#define XED_ISA_SET_APX_F_AMX_TRANSPOSE_MOVRS_DEFINED 1
...
typedef enum {
  ...
  XED_ISA_SET_APX_F_AMX_TRANSPOSE,
  XED_ISA_SET_APX_F_AMX_TRANSPOSE_MOVRS,
