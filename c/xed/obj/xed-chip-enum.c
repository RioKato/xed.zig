...
{"EMERALD_RAPIDS", XED_CHIP_EMERALD_RAPIDS},
{"GRANITE_RAPIDS", XED_CHIP_GRANITE_RAPIDS},
{"DIAMOND_RAPIDS", XED_CHIP_DIAMOND_RAPIDS},
{"SIERRA_FOREST", XED_CHIP_SIERRA_FOREST},
{"CLEARWATER_FOREST", XED_CHIP_CLEARWATER_FOREST},
{"ARROW_LAKE", XED_CHIP_ARROW_LAKE},
{"LUNAR_LAKE", XED_CHIP_LUNAR_LAKE},
{"PANTHER_LAKE", XED_CHIP_PANTHER_LAKE},
...
Here is a skeleton switch statement embedded in a comment
  ...
  case XED_CHIP_EMERALD_RAPIDS:
  case XED_CHIP_GRANITE_RAPIDS:
  case XED_CHIP_DIAMOND_RAPIDS:
  case XED_CHIP_SIERRA_FOREST:
  case XED_CHIP_CLEARWATER_FOREST:
  case XED_CHIP_ARROW_LAKE:
  case XED_CHIP_LUNAR_LAKE:
  case XED_CHIP_PANTHER_LAKE:
