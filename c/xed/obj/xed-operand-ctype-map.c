...
void xed_init_operand_ctypes(void)
{
   ...
   xed_operand_ctype[XED_OPERAND_ENCODE_FORCE]=XED_OPERAND_CTYPE_XED_BITS_T;
   ...
   xed_operand_ctype[XED_OPERAND_NOREX2]=XED_OPERAND_CTYPE_XED_BITS_T;
   ...
   xed_operand_ctype[XED_OPERAND_REX2]=XED_OPERAND_CTYPE_XED_BITS_T;
   xed_operand_ctype[XED_OPERAND_REXB4]=XED_OPERAND_CTYPE_XED_BITS_T;
   xed_operand_ctype[XED_OPERAND_REXX4]=XED_OPERAND_CTYPE_XED_BITS_T;
   xed_operand_ctype[XED_OPERAND_REXR4]=XED_OPERAND_CTYPE_XED_BITS_T;
   xed_operand_ctype[XED_OPERAND_HAS_EGPR]=XED_OPERAND_CTYPE_XED_BITS_T;
   ...
   xed_operand_ctype[XED_OPERAND_NEED_SIB]=XED_OPERAND_CTYPE_XED_BITS_T;
   ...
   xed_operand_ctype[XED_OPERAND_ABSBR]=XED_OPERAND_CTYPE_XED_BITS_T;
   ...
   xed_operand_ctype[XED_OPERAND_REG9]=XED_OPERAND_CTYPE_XED_REG_ENUM_T;
   ...
   xed_operand_bits[XED_OPERAND_NOREX2]=1;
   ...
   xed_operand_bits[XED_OPERAND_REX2]=1;
   xed_operand_bits[XED_OPERAND_REXB4]=1;
   xed_operand_bits[XED_OPERAND_REXX4]=1;
   xed_operand_bits[XED_OPERAND_REXR4]=1;
   xed_operand_bits[XED_OPERAND_HAS_EGPR]=1;
   ...
   xed_operand_bits[XED_OPERAND_NEED_SIB]=1;
   ...
   xed_operand_bits[XED_OPERAND_ABSBR]=1;
   ...
   xed_operand_bits[XED_OPERAND_REG9]=16;
