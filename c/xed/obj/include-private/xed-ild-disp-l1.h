...
static XED_INLINE void xed_lookup_function_RESOLVE_BYREX2_DISP_maplegacy_map0_op0xa1_l1(xed_decoded_inst_t* x);
...
{
xed_bits_t _rex2;
_rex2 = (xed_bits_t)xed3_operand_get_rex2(x);
switch(_rex2) {
case 0:
xed_lookup_function_MEMDISPv_DISP_WIDTH_ASZ_NONTERM_EASZ_l2(x);
break;
case 1:
xed_lookup_function_BRDISP64_BRDISP_WIDTH_CONST_l2(x);
break;
