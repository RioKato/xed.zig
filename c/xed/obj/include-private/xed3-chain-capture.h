...
static XED_INLINE xed_error_enum_t xed3_capture_chain_BRDISP64(xed_decoded_inst_t* d);
...
static XED_INLINE xed_error_enum_t xed3_capture_chain_EVEXR4_ONE_FIX_ROUND_LEN128(xed_decoded_inst_t* d);
...
static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_SIMM8(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_SIMMz(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_SIMMz(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_SCC(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_SCC(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_SCC_SIMM8(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_SCC_SIMM8(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_SCC_SIMMz(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_SCC_SIMMz(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_UIMM8(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_MODRM_EVAPX_UIMM8(xed_decoded_inst_t* d);

static XED_INLINE xed_error_enum_t xed3_capture_chain_EVAPX_ONE(xed_decoded_inst_t* d);
