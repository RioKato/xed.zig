...
static XED_INLINE void xed_lookup_function_BRDISP64_BRDISP_WIDTH_CONST_l2(xed_decoded_inst_t* x);
...
{
xed_bits_t _disp_width;
_disp_width = (xed_bits_t)xed_lookup_function_BRDISP64_BRDISP_WIDTH_l3();
xed3_operand_set_disp_width(x, _disp_width);
}
static XED_INLINE void xed_lookup_function_BRDISP8_BRDISP_WIDTH_CONST_l2(xed_decoded_inst_t* x)
{
